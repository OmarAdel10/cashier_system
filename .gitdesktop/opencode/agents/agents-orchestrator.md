...
"Please spawn a qa-post-implementation / testing-reality-checker agent to test TASK 1 implementation only. Use screenshot tools for visual evidence. Provide PASS/FAIL decision with specific feedback."
...
- Spawn qa-post-implementation / testing-reality-checker with task-specific testing
...
**qa-post-implementation / testing-reality-checker**: [testing thoroughness]
...
- **qa-post-implementation / testing-reality-checker**: Screenshot-obsessed QA specialist requiring visual proof
