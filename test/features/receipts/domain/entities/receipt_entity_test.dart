...
void main() {
  group('ReceiptEntity', () {
    ...
    test('toString should return correct format', () {
      expect(
        receipt.toString(),
        'ReceiptEntity(id: r1, orderNumber: ORD-001, status: ReceiptStatus.active, stockUpdated: true, stockFailedBarcodes: [], modificationCount: 0, amountPaidPiastres: null, paymentType: cash)',
      );
    });
  });
