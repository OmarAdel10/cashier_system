class LocalizationService {
  static const Map<String, Map<String, String>> _translations = {
    'ar': {
      ...
      'checkout.time.quarters': 'ربع ساعة: {0}',
      'checkout.time.minus': 'ناقص 15 دقيقة',
      'checkout.time.plus': 'زائد 15 دقيقة',
      'checkout.time.total': 'المبلغ الإجمالي',
      'checkout.time.confirm': 'تأكيد',
    ...
    'en': {
      ...
      'checkout.time.quarters': 'Quarter hours: {0}',
      'checkout.time.minus': 'Minus 15 minutes',
      'checkout.time.plus': 'Add 15 minutes',
      'checkout.time.total': 'Total amount',
      'checkout.time.confirm': 'Confirm',
