class LocalizationService {
  static const Map<String, Map<String, String>> _translations = {
    'ar': {
      ...
      'onboarding.welcome.subtitle': 'نظام الكاشير يساعدك على إدارة متجرك بسهولة وسرعة',
      ...
      'onboarding.features.item1.subtitle': 'أضف المنتجات وأكمل البيع في خطوات بسيطة',
      'onboarding.features.item2.title': 'إدارة المخزون',
      'onboarding.features.item2.subtitle': 'تابع منتجاتك وأسعارك وكمياتك من مكان واحد',
    ...
    'en': {
      ...
      'onboarding.welcome.subtitle': 'Cashier System helps you manage your store easily and quickly',
      ...
      'onboarding.features.item1.subtitle': 'Add products and complete sales in simple steps',
      'onboarding.features.item2.title': 'Inventory Management',
      'onboarding.features.item2.subtitle': 'Track your products, prices, and stock in one place',
      'onboarding.features.item3.title': 'Sales Reports',
      'onboarding.features.item3.subtitle': 'Monitor your daily sales and revenue',
      ...
      'onboarding.adminSetup.subtitle': 'Choose a password for the admin account',
