...
class AppReceiptModel extends ReceiptEntity {
  ...
  factory AppReceiptModel.fromJson(Map<String, dynamic> json) {
    return AppReceiptModel(
      ...
      stockFailedBarcodes:
          (json['stockFailedBarcodes'] as List<dynamic>?)?.cast<String>() ??
          const [],
      status: ReceiptStatus.values[json['status'] as int? ?? 0],
      modificationCount: json['modificationCount'] as int? ?? 0,
      amountPaidPiastres: json['amountPaidPiastres'] as int?,
...
class AppReceiptModelAdapter extends TypeAdapter<AppReceiptModel> {
  ...
  AppReceiptModel read(BinaryReader reader) {
    ...
    return AppReceiptModel(
      ...
      stockFailedBarcodes:
          (fields[13] as List<dynamic>?)?.cast<String>() ?? const [],
      taxPercent: fields[14] as int? ?? 0,
      discountPercent: fields[15] as int? ?? 0,
      amountPaidPiastres: fields[16] as int?,
      paymentType: fields[17] as String? ?? 'cash',
    );
  }
  ...
  void write(BinaryWriter writer, AppReceiptModel obj) {
    ...
    writer.writeByte(10);
    writer.write(obj.stockUpdated);
    writer.writeByte(11);
    writer.write(obj.status.index);
    writer.writeByte(12);
    writer.write(obj.modificationCount);
    writer.writeByte(13);
    writer.write(obj.stockFailedBarcodes);
    writer.writeByte(14);
